...
Judge model-written regexes by running them against a held-out labelled corpus, not by comparing patterns

Catalog task: `EVAL-019`. One of a public catalog of build ideas: https://github.com/JesseRWeigel/722-things-to-build
